...
const POIS = {
  "New York / NJ": [
    ...
    { name:"Official Team Hotel",lat:40.7580,lng:-73.9855,type:"hotel",icon:"🏨" },
  ...
  "Los Angeles": [
    ...
    { name:"Official Team Hotel",lat:33.9850,lng:-118.4695,type:"hotel",icon:"🏨" },
  ...
  "Mexico City": [
    ...
    { name:"Official Team Hotel",lat:19.4270,lng:-99.1677,type:"hotel",icon:"🏨" },
  ],
  "Dallas": [
    { name:"DFW Airport",lat:32.8998,lng:-97.0403,type:"airport",icon:"✈️" },
    { name:"Official Team Hotel",lat:32.7870,lng:-97.0810,type:"hotel",icon:"🏨" },
  ],
  "Miami": [
    { name:"MIA Airport",lat:25.7959,lng:-80.2870,type:"airport",icon:"✈️" },
    { name:"Official Team Hotel",lat:25.7617,lng:-80.1918,type:"hotel",icon:"🏨" },
  ],
  "Toronto": [
    { name:"Pearson Airport",lat:43.6777,lng:-79.6248,type:"airport",icon:"✈️" },
    { name:"Official Team Hotel",lat:43.6426,lng:-79.3871,type:"hotel",icon:"🏨" },
  ],
  "Atlanta": [
    { name:"ATL Airport",lat:33.6407,lng:-84.4277,type:"airport",icon:"✈️" },
    { name:"Official Team Hotel",lat:33.7600,lng:-84.3880,type:"hotel",icon:"🏨" },
  ],
  "Houston": [
    { name:"IAH Airport",lat:29.9902,lng:-95.3368,type:"airport",icon:"✈️" },
    { name:"Official Team Hotel",lat:29.7504,lng:-95.3698,type:"hotel",icon:"🏨" },
  ],
};

const LOC=["Stadium","Team Hotel","Airport","Training Ground","Media Center","Official Hotel","Fan Zone"];
...
const FEED=[
  ...
  {t:"s",i:"✓",h:"VIP SUV — Tournament Officials",d:"Dallas · AT&T Stadium",tm:"35m",cls:""},
];
    ...
    <div style={{display:"grid",gridTemplateRows:"auto auto 1fr",height:"100vh",background:"#060a14",color:"#eef1f8",fontFamily:"'DM Sans',system-ui,sans-serif",fontSize:13}}>
      ...
      <header style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 20px",height:50,background:"#0c1222",borderBottom:"1px solid rgba(255,255,255,.08)"}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <div style={{width:30,height:30,background:"linear-gradient(135deg,#00997b,#007a62)",borderRadius:7,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:700,fontSize:9,color:"#fff",...mono,boxShadow:"0 2px 6px rgba(0,153,123,.25)"}}>WC26</div>
          <div><div style={{fontSize:13,fontWeight:700}}>World Cup 2026™</div><div style={{fontSize:8,fontWeight:600,...mut,letterSpacing:1.8,textTransform:"uppercase"}}>Transport Operations</div></div>
